...
public class Post {
    ...
    @ManyToMany
    @JoinTable(
            name = "post_tags", // this is what hibernate will generate for us
            joinColumns = @JoinColumn(name = "post_id"),
            inverseJoinColumns = @JoinColumn(name = "tag_id")
    )
    private Set<Tag> tags = new HashSet<>(); // we use set here because it prevents duplicates and the order of tags is not important to us
